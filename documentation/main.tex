...
When working with CNN classifier, we need to know the exact dimensions for our 
...
TODO o tom jak v skratke funguje a odkaz na code2vec.
...
\subsection{Pipeline execution: Workflow and the training process}
